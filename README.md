...
O servidor escuta na porta `3001` com WebSocket. O cliente tenta se conectar ao
mesmo host utilizado para abrir a página. Certifique-se de iniciar o servidor
antes de clicar em **Encontrar Partida**.
